...
function ejercicio() {
    ...
    escribir( contenedor, 'Un banco generoso da de interés el ',`(${porcentaje}`,'% anual. Si depositas $',`(${dinero}`,' ¿Qué monto tendrás al cabo de ',`${años}`,' años?',' Escriba la solución con dos cigras decimales.')
}
